...
export const terminalInterfaces: Record<TerminalInterfaceId, TerminalInterfaceDefinition> = {
  city: {
    ...
    tabs: ['new_game', 'onboarding', 'dashboard', 'campaigns', 'timeline', 'sectors', 'population', 'citizens', 'informants', 'civil_protection', 'rationing', 'propaganda', 'reports', 'decision_history', 'archives', 'video_archives', 'save_system', 'difficulty', 'gameplay_balance', 'atmosphere', 'tauri_packaging', 'ux_polish', 'codex', 'system_audit'],
    primaryTabs: ['new_game', 'onboarding', 'dashboard', 'sectors', 'population', 'civil_protection', 'rationing', 'gameplay_balance', 'tauri_packaging', 'ux_polish'],
