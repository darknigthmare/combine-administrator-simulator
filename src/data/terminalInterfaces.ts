...
export const terminalInterfaces: Record<TerminalInterfaceId, TerminalInterfaceDefinition> = {
  city: {
    ...
    tabs: ['onboarding', 'command_deck_v2', 'progression', 'campaigns', 'timeline', 'sectors', 'population', 'citizens', 'informants', 'civil_protection', 'resistance', 'rationing', 'propaganda', 'reports', 'decision_history', 'archives', 'video_archives', 'save_system', 'difficulty', 'atmosphere', 'codex'],
    primaryTabs: ['onboarding', 'command_deck_v2', 'progression', 'sectors', 'population', 'civil_protection', 'rationing'],
  ...
  citadel: {
    ...
    tone: 'overwatch',
    defaultTab: 'citadel',
    tabs: ['citadel', 'technology', 'overwatch', 'combine', 'major_events', 'finale', 'chronicle', 'reports', 'decision_history', 'archives', 'video_archives', 'save_system', 'difficulty', 'atmosphere', 'codex'],
    primaryTabs: ['citadel', 'technology', 'overwatch', 'combine'],
  ...
  quarantine: {
    ...
    tone: 'biohazard',
    defaultTab: 'xen',
    tabs: ['xen', 'xen_research', 'xen_catastrophes', 'vortigaunts', 'sectors', 'population', 'reports', 'decision_history', 'archives', 'video_archives', 'codex'],
